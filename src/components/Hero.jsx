  ...
  return (
    <div className='container flex flex-col mx-auto p-3'>
      <div className=' bg-hero bg-cover bg-center  rounded-xl'>
        <div className='px-10 lg:pl-28 pt-28 md:w-[500px] lg:w-[700px] animate-fadeIn'>
          <h1 className='text-3xl md:text-4xl lg:text-6xl font-semibold text-white lg:leading-snug mb-4'>
            Order your favourite food here
          </h1>
          <p className='text-sm font-semibold text-white mb-8'>
            Choose from diverse meu featuring a delectable array of dishes crafted with the finest
          ...
          <button
            type='button'
            className='px-8 py-3 bg-white rounded-full mb-10 text-sm font-semibold'
          >
            View menu
          </button>
        </div>

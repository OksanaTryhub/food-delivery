        ...
        <div className="flex flex-col sm:grid grid-cols-footer gap-10 sm:gap-14">
          <div className="flex flex-col gap-5 px-3 lg:pr-8 xl:pr-14">
            <Link to="/" onClick={handleLogoClick}>
              <img
                src={logo}
                alt="logo"
                className="min-w-[100px] max-w-[100px] sm:max-w-[120px]"
              />
            </Link>
            <p className="text-xs ">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque
              ipsam velit porro alias. Sint, optio pariatur. Pariatur officia
              harum ab. Quas placeat quia ipsa quo nihil possimus eius dolores
          ...
          <div className="flex flex-col px-3 md:pl-8 ">
            ...
            <ul className="flex flex-col gap-1 sm:gap-2 text-sm md:text-base">
              <li className="cursor-pointer text-sm hover:text-accent-1">
                Home
              </li>
              <li className="cursor-pointer text-sm hover:text-accent-1">
                About us
          ...
          <div className="flex flex-col gap-4 px-3 md:pl-8">
            ...
            <ul className="flex flex-col gap-1 sm:gap-2 text-sm md:text-base">
              ...
              <li className="cursor-pointer text-sm group">
                <a
                  href="mailto:ksanatrigub@gmail.com"
                  className="flex gap-2 items-center"
                >
